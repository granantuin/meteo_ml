...
Original file is located at
    https://colab.research.google.com/drive/1VmCMoYLv8B7RmahCMKVWWFvFPHmVI6oA
"""

#@title Select station coordinates (N+ S- W- and E+) and n nearest points
lat_station = 42.898 #@param {type:"number"}
lon_station = -8.418 #@param {type:"number"}
n_nearest =  4#@param {type:"integer"}
forecast_D = 1 #@param ["0", "1", "2", "3"] {type:"raw"}
initial_day_YYYYMMDD = "20100101" #@param {type:"raw"}
