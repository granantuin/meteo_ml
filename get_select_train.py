...
#defining independent variable and label y
y_var = ["visibility_o"] #@param ["[\"mod_o\"]", "[\"temp_o\"]", "[\"spd_o\"]", "[\"visibility_o\"]", "[\"dir_o\"]", "[\"dir_o\",\"spd_o\"]", "[\"wind_gust_o\"]", "[\"wxcodes_o\"]", "[\"skyc1_o\"]", "[\"skyl1_o\"]", "[\"temp_o\"]", "[\"tempd_o\"]", "[\"gust_spd_o\"]", "[\"prec_accumulated_1_hour_before_o\"]"] {type:"raw", allow-input: true}
...
x_var=["dir0","dir1","dir2","dir3","dir4"]
x_var=["prec0","prec1","prec2","prec3"]

"""

x_var=["visibility0","visibility1","visibility2","visibility3"]
...
#0model=RandomForestClassifier(n_estimators=300,class_weight='balanced')
#model=BalancedRandomForestClassifier(n_estimators=300)
#model=BalancedBaggingClassifier()
#model=BaggingClassifier()
#model=lgbm.LGBMClassifier()
#model=LogisticRegression()
model=ExtraTreesClassifier(bootstrap=True, ccp_alpha=0.0, class_weight='balanced',
                     ...
                     warm_start=False)
#model=MLPClassifier(hidden_layer_sizes=(350,100),learning_rate="adaptive",verbose=False, 
