...
def selectx_pca_train(df_all):
    ...
    models=[KNeighborsClassifier(n_neighbors=3),  XGBClassifier(n_estimators=400),
            ...
            MLPClassifier(hidden_layer_sizes=(250,100),verbose=False,early_stopping=True,max_iter=2500,alpha=0.0001),
            ...
            ExtraTreesClassifier(n_estimators=200,class_weight="balanced"), RandomForestClassifier()]
