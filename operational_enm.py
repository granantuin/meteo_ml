...
#select x _var
model_x_var=meteo_model[algo_g_d0["x_var"]]

#forecast variables knots
forecast=(algo_g_d0["ml_model"].predict(model_x_var)*1.94384).round(1)

#compare results
df_show=pd.DataFrame({"Machine Learning nudos":forecast,"Modelo meteorológico nudos":w_g0,
