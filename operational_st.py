...
df_expla=pd.DataFrame({"meteorologicalvariablecode":["dir","spdb"],"meteorological variable explanation":
                       ["Wind direction", "Wind speed Beaufort scale"]})
st.table(df_expla)    
...
st.dataframe(ml_result.style.highlight_max(axis=1))
