...
algorithm_file=st.sidebar.selectbox('select algorithm',("st_spd_olat42.58lon-8.8046p4R4KmD0.al",))
algo=pickle.load(open(algorithm_file,"rb"))

key_selected=st.sidebar.selectbox("select quality report",('global', 'column', 'index', 'class','cros_val'))
reports={"global":0,"column":1,"index":2,"class":3,"cros_val":0}
...
if algo["x_and_y_same"]:
    ...
    st.title("Meteorological model result")
    st.dataframe(df_x[points_met_model])  
