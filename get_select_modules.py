...
def selectx_pca_train(df_all):
    ...
    return x_var, x_sc, x_pca, model, y_pred, y_test


met_model,met_station,df_x,df_y,df_all = select_metmodel_station()    
interval, labels, df_all,y_var = label_y(df_all) 
met_var_sc, x_and_y_same = metmodel_score(df_all,y_var)
x_var,x_sc,x_pca,model, y_pred,y_test = selectx_pca_train(df_all)
