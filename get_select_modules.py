...
def m_learning_sc (y_test, y_pred, x_var, scaler, pca, df_all):
    ...
    cross_vali=input("cross validation (y/n) ?\n")
    if cross_vali =="y":
    ...
    return global_ml, column_ml, index_ml , clas_ml ,cros_val
...
global_ml, column_ml, index_ml , clas_ml, cros_val = m_learning_sc (y_test, y_pred, x_var, scaler, pca, df_all)
